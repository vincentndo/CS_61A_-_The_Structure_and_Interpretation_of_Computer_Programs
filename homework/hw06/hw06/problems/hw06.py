...
def balanced(m):
    ...
    if is_weight(m):
        ...
        return (length(s[0]) * total_weight(left) == length(s[1]) * total_weight(right)) and balanced(left) and balanced(right)
...
def make_withdraw(balance, password):
    ...
    def withdraw(amount, string):
        ...
        if count < 3:
            ...
            return 'Your account is locked. Attempts: [\'{}\', \'{}\', \'{}\']'.format(p[0], p[1], p[2])
...
def make_joint(withdraw, old_password, new_password):
    ...
    if isinstance(ret, str):
        ...
        def helper(amount, password):
            if password in p or password == old_password:
