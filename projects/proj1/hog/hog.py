...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    if num_rolls == 0:
        ...
        if is_prime(points):
            score = min(25 - num_rolls, next_prime(points))
        else:
            score = min(25 - num_rolls, points)
...
def swine_swap(score0, score1):
    """Swap two scores if one is doubled the other
...
def check_strategy(strategy, goal=GOAL_SCORE):
    ...
    while score0 <= goal:
        ...
        while score1 <= goal:
            ...
            if type(num_rolls) != int or num_rolls < -1 or num_rolls > 10:
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while num_rolls > 0:
        ...
        new_average = average(num_rolls, dice)

        if max_score < new_average:
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    swapped_score, swapped_oponent_score = swine_swap(new_score, opponent_score)
    
    if swapped_score > new_score:
        return 0
    elif swapped_score == new_score:
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if score >= GOAL_SCORE - 5:
        return bacon_strategy(score, opponent_score, margin=4, num_rolls=2)
    elif score >= GOAL_SCORE - 10:
        return bacon_strategy(score, opponent_score, margin=5, num_rolls=3)
    elif score >= GOAL_SCORE - 15:
        return bacon_strategy(score, opponent_score, margin=6, num_rolls=4)

    default = swap_strategy(score, opponent_score, 7, 4)
